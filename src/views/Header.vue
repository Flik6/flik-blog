<template>
  ...
  >
    ...
    >
      ...
      <a-form-item :wrapper-col="{ offset: 8, span: 16 }">
        <a-button type="primary" :disabled="disabledLogin" html-type="submit" style="margin-right: 10px" @click="submitLoginData()">登录</a-button>
  ...
  >
    ...
    >
      ...
      <a-form-item :wrapper-col="{ offset: 8, span: 16 }">
        <a-button type="primary" :disabled="disabledRegister" html-type="button" @click="registerUser()">注册</a-button>
      </a-form-item>
    </a-form>
  </a-drawer>
</template>
